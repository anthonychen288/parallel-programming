#ifndef _MyBMP_Custom_Math_Functions_
#define _MyBMP_Custom_Math_Functions_
...
#ifndef _MyBMP_Defined_WINGDI
#define _MyBMP_Defined_WINGDI
 typedef unsigned char  ebmpBYTE;
 typedef unsigned short ebmpWORD;
 typedef unsigned int  ebmpDWORD;
#endif

#ifndef _MyBMP_DataStructures_h_
#define _MyBMP_DataStructures_h_
